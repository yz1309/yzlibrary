...
public class ChineseCalendarGB {
	...
	final static long[] TttInfo = new long[] { 0x04bd8, 0x04ae0, 0x0a570,
	...
	public void setCalendar(Calendar cal) {
		...
		calendarMonth = cal.get(Calendar.MONTH) == 12 ? 1 : cal.get(Calendar.MONTH) + 1;
